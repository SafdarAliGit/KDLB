...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		self.set_surcharge_field()
	
	def set_surcharge_field(self):
		self.get_surcharge_details()
		for d in self.data:
	...
	def get_surcharge_details(self):
		...
		surcharge_details = []
		date_field = 'due_date' if self.filters.ageing_based_on == "Due Date" else 'posting_date'
		self.filters.report_date
	...
	def setup_ageing_columns(self):
		...
		self.add_column(label="Surcharge", fieldname="surcharge")
		self.add_column(label="Amount After Surcharge", fieldname="amount_after_surcharge", width=180)
